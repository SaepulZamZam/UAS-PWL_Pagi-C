                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $no++}}</td>
                            <td>
                                <img src="{{ asset( asset('storage/artikel/'. $artikel->image))}}" height="100" alt="">
                            </td>
                            <td>
                                {{ $artikel->judul }}
                            </td>
                            <td>
                                ...
                                <form action="{{ route('blog.destroy', $artikel->id)}}" method="POST" class="d-inline">
                                    @csrf
                                    <button type="submit" onclick="alert('Apakah anda yakin akan menhapus nya ?')" class="btn btn-danger">Hapus</button>
                                </form>
                            </td>
                        </tr>
